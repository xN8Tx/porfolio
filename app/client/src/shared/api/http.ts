...
// TODO: Переделать это под ключи для i18n
const statusTextByCode = {
  ...
  "401": "Извините для вашего запроса требуется авторизация.",
  "403":
    "Извините вам отказано в доступе. Если вы уверены в правах, обратитесь к администратору.",
  "500": "Извините, что-то пошло не так. Попробуйте позже.",
};
